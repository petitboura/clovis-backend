...
Deux niveaux, même logique "à la skill" que les comportements :
...
- obtenir_structure_programme : structure complète (matières + chapitres
  + limites), demandée par le modèle via l'outil consulter_programme
  (voir core/serveur_mcp_generation.py) seulement s'il en a besoin.
