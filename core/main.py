...
def _router_outils(message_utilisateur, outils_disponibles, historique=None):
    ...
    prompt_routeur = (
        ...
        "lire_article_connaissance ; si l'utilisateur veut le FICHIER "
        "lui-même en pièce jointe dans la conversation (pas juste lire "
        "son contenu -- ex : \"montre le fichier\", \"envoie-le moi tel "
        "quel\", \"donne-moi le .md\"), suggère obtenir_fichier_connaissance "
        "à la place ; si le nom exact de l'article n'est "
